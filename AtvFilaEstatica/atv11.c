...
int main(){
    ...
    case 4:
        while(op != 2){
            printf("====OPCOES-EXERCICIO-11====\n1.Mostrar todos os elementos divisiveis por 3\n2.Sair\n====================\n\n");
            op = lerInteiro("Digite sua opcao: ");
            switch (op){
            case 1:
                if(isEmpty(f)){printf("!!Fila Vazia!!\n");break;}
                mostrarDivisiveis(f, divisiveis);
                mostrarFila(divisiveis);
                break;
            case 2:
                printf("Voltando...\n");
                break;
